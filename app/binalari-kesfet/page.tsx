...
import { SehirEtiketi, useSehirMetni } from '@/app/lib/sehir';

export default function BinalariKesfetSayfasi() {
  const { t } = useLang();
  const ts = useSehirMetni(); // {sehirler} yerine açık şehirlerin listesi
  ...
  return (
    <div className="min-h-screen bg-white text-[#0f172a] font-sans flex flex-col">
      ...
      <section className="max-w-3xl w-full mx-auto px-6 pb-20 flex-1">
        ...
        <p className="text-[15px] leading-relaxed text-slate-600 mt-5">{ts('bk.giris')}</p>
