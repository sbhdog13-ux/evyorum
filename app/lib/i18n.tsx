...
const SOZLUK: { [dil: string]: { [k: string]: string } } = {
  tr: {
    ...
    'acilis.girisKayit': 'GİRİŞ YAP / KAYIT OL', 'acilis.girisKisa': 'GİRİŞ YAP', 'acilis.hemenBasla': 'HEMEN BAŞLA →', 'acilis.yakinda': "APP STORE'DA İNDİR →",
    'acilis.aramaPh': 'İlçe, mahalle veya bina adı gir…', 'acilis.aramaBtn': 'BİNANI BUL', 'acilis.sonMuhurler': 'Son Mühürler', 'acilis.canli': 'Canlı · İstanbul', 'acilis.muhurleBtn': 'MÜHÜRLE',
    ...
    'sehir.etiket': 'ŞEHİR', 'sehir.baslik': 'HANGİ ŞEHİRDE BAKIYORSUN?', 'sehir.yeni': 'YENİ', 'sehir.menu': 'ŞEHİR',
    'sehir.alt': 'Seçimini hatırlarız. İstediğin an üstten değiştirebilirsin.',
    'sehir.disarida': 'Sadece {sehir}: Seçili şehrin dışına mühür basılamaz. Harita {sehir} merkezine döndürüldü. Başka şehir için menüden şehri değiştir.',
    'sehir.haritaBaslik': 'HANGİ ŞEHRİN HARİTASI?', 'sehir.secili': 'SEÇİLİ', 'sehir.kapat': 'Kapat',
    'sehir.haritaAlt': 'Haritayı seçtiğin şehirde açarız. Seçimin tüm sayfalara uygulanır.',
    'sehir.bos': 'Bu şehirde henüz mühürlü bina yok. İlk mührü sen bas.',
    'sehir.gecisBaslik': '{sehir} İLİNE GEÇİŞ YAPIYORSUNUZ', 'sehir.tamam': 'TAMAM',
    'bina.galeriAc': 'Fotoğrafları büyüt', 'bina.galeri': 'Bina fotoğrafları',
    'bina.googleFoto': 'Google sokak görünümü', 'bina.sakinFoto': 'Sakin fotoğrafı',
    'bina.oncekiFoto': 'Önceki fotoğraf', 'bina.sonrakiFoto': 'Sonraki fotoğraf',
    'sehir.olusturDisarida': 'Seçtiğin konum {sehir} sınırlarının dışında. Bina, seçili ilin içinde olmalı. Başka bir ildeyse önce menüden ili değiştir.',
    'sehir.gecisAlt': 'Bu bina {sehir} ilinde. Site artık {sehir} için gösteriliyor. İstediğin an menüden değiştirebilirsin.',
    ...
    'y.krit1': 'Isınma', 'y.krit2': 'Deprem', 'y.krit3': 'Komşuluk', 'y.krit4': 'Yönetim', 'y.krit5': 'Güvenlik', 'y.krit6': 'Aidat',
    'y.kritEkle': '+ kendi kriterini ekle',
    'y.arti': 'ARTI', 'y.sorun': 'SORUN',
    'y.nelerNot': "İstanbul'un 39 ilçesinde · Ücretsiz · İstersen anonim",
    'y.nelerNot@kahramanmaras': "Kahramanmaraş'ın 11 ilçesinde · Ücretsiz · İstersen anonim",
    'y.kaydir': 'AŞAĞI İN, YOLCULUK BAŞLIYOR', 'y.hizli': 'HIZLI BAK:',
    'y.a1rozet': 'HARİTADA GEZİNİRKEN', 'y.a1b1': '"DUR, BURAYI', 'y.a1b2': 'BİLİYORUM."',
    'y.a1alt': "Kadıköy'de oturdun, Beşiktaş'ta okudun, Şişli'de çalıştın. Tanıdığın yerlerin karnesi neye benziyor?",
    'y.muhurler': 'MÜHÜR',
    'y.a2rozet': 'BİR İLÇEYE GİRDİN', 'y.a2b1': '"PEKİ İNSANLAR', 'y.a2b2': 'NE DEMİŞ?"',
    'y.a2alt': 'İlan metni değil, orada yaşamış insanların kendi cümleleri. İyisiyle kötüsüyle.',
    'y.a3rozet': 'BİR BİNA İLGİNİ ÇEKTİ', 'y.a3b1': '"BU BİNANIN', 'y.a3b2': 'KARNESİ NE?"',
    'y.a3alt': 'Tek tek yorumları okumak zorunda değilsin. Hepsi tek karnede toplanıyor.',
    'y.agBaslik': 'Her mühür aynı ağırlıkta değil. Kim söylüyor önemli:',
    'y.agSakin': 'Sakin — hâlâ o binada oturuyor',
    'y.agEski': 'Eski sakin — bir dönem yaşadı',
    'y.agZiyaret': 'Ziyaretçi — sadece uğradı',
    'y.agNot': 'Böylece tek bir kızgın yorum binanın karnesini bozamıyor, gerçekten yaşayanın sözü ağır basıyor.',
    'y.a4rozet': 'VE ASIL MERAK ETTİĞİN', 'y.a4b1': '"YA BENİM', 'y.a4b2': 'BİNAM?"',
    'y.a4alt': 'Oturduğun ya da taşınmayı düşündüğün binanın adını yaz. Bakalım hakkında ne yazılmış.',
    'y.yoksa': 'Binan henüz yoksa — sen ekle. İlk mührü sen basarsın, o binanın hafızası seninle başlar.',
    'y.binaEkle': 'BİNA EKLE',
    'y.a5rozet': 'YOLCULUĞUN SONU, HAFIZANIN BAŞI', 'y.a5b1': 'SEN DE BİNANI', 'y.a5b2': 'MÜHÜRLE.',
    'y.a5alt': 'Bir binada yaşadıysan, o deneyim başka birinin doğru kararı vermesini sağlayabilir. İki dakika sürüyor.',
    'y.a5not': 'Ücretsiz · İstersen tamamen anonim · Kimliğin kimseyle paylaşılmaz',
    ...
    'nc.s1b': 'Ara', 'nc.s1': "Merak ettiğin binayı adıyla, sokağıyla ya da ilçesiyle ara; dilersen haritadan gez. Seçtiğin şehirde mühürlenmiş her bina karşına çıkar.",
    ...
    'nc.kutu1': 'Bunu hep birlikte yapıyoruz. Her mühür tek başına küçük bir nottur; birleştiğinde şehrin bina hafızasını oluşturur. Buradaki otorite bir şirket değil — ', 'nc.kutu2': 'yaşamış insanların kendisi.',
    'nc.cta': 'HEMEN BAŞLA →',
    ...
    'bk.giris': "Merak ettiğin binayı, oraya taşınmadan tanı. Keşfet, seçtiğin şehirde mühürlenmiş binaları harita ve liste üzerinden gördüğün yerdir. Şu an açık olduğumuz şehirler: {sehirler}. Bir binanın adını, sokağını ya da ilçesini yaz; orada gerçekten yaşamış insanların bıraktığı puanları, deneyimleri ve çevre analizini tek ekranda incele.",
    ...
    'bk.k1b': '🗺️ Haritadan', 'bk.k1': 'Şehrin haritasında mühürlenmiş binaları gör; ilçeye, sokağa yaklaş, ilgilendiğin binaya dokun.',
    ...
    // Kahramanmaraş seçiliyken bunlar gelir (bkz. useSehirMetni)
    'fo.ilceler@kahramanmaras': 'Kahramanmaraş İlçeleri',
    'ilc.h1a@kahramanmaras': "Kahramanmaraş'ı",
    'ilc.g1@kahramanmaras': "Kahramanmaraş, Ahır Dağı'nın eteğinden Ceyhan vadisine, Elbistan ovasından Andırın'ın yaylalarına uzanan 11 ilçesiyle köklü bir Anadolu şehridir. Kurtuluş Savaşı'nda kazandığı \"Kahraman\" unvanıyla, dondurmasıyla, el emeğiyle tanınır; her mahallenin kendi ritmi, kendi komşuluğu, kendi hayatı vardır.",
    'ilc.g2a@kahramanmaras': "6 Şubat 2023 depremlerinden sonra şehir yeniden kuruluyor: yeni yapılar yükseliyor, mahalleler yeniden şekilleniyor. Böyle bir dönemde bir binanın içini dışarıdan bilmek neredeyse imkânsızdır; aynı sokakta iki bina bambaşka iki hayat sunabilir. Bu yüzden Bulevini Kahramanmaraş'ı ilçe ilçe değil, ",
    'ilc.davet2@kahramanmaras': " Kahramanmaraş'ın hafızasını birlikte yazıyoruz — ilk mührü sen bas.",
  ...
  en: {
    ...
    'acilis.girisKayit': 'SIGN IN / SIGN UP', 'acilis.girisKisa': 'SIGN IN', 'acilis.hemenBasla': 'GET STARTED →', 'acilis.yakinda': 'DOWNLOAD ON THE APP STORE →',
    'acilis.aramaPh': 'District, neighborhood or building name…', 'acilis.aramaBtn': 'FIND YOUR BUILDING', 'acilis.sonMuhurler': 'Latest Seals', 'acilis.canli': 'Live · Istanbul', 'acilis.muhurleBtn': 'SEAL IT',
    ...
    // --- Landing journey ---
    'sehir.etiket': 'CITY', 'sehir.baslik': 'WHICH CITY ARE YOU LOOKING IN?', 'sehir.yeni': 'NEW', 'sehir.menu': 'CITY',
    'sehir.alt': 'We will remember your choice. You can change it anytime from the top.',
    'sehir.disarida': 'Only {sehir}: You can only seal buildings inside the selected city. The map went back to {sehir}. To use another city, change it from the menu.',
    'sehir.haritaBaslik': 'WHICH CITY\'S MAP?', 'sehir.secili': 'SELECTED', 'sehir.kapat': 'Close',
    'sehir.haritaAlt': 'We open the map in the city you choose. Your choice applies to every page.',
    'sehir.bos': 'No sealed buildings in this city yet. Be the first to seal one.',
    'sehir.gecisBaslik': 'SWITCHING TO {sehir}', 'sehir.tamam': 'OK',
    'bina.galeriAc': 'Enlarge photos', 'bina.galeri': 'Building photos',
    'bina.googleFoto': 'Google Street View', 'bina.sakinFoto': 'Resident photo',
    'bina.oncekiFoto': 'Previous photo', 'bina.sonrakiFoto': 'Next photo',
    'sehir.olusturDisarida': 'The location you picked is outside {sehir}. The building must be inside the selected city. If it is in another city, change the city from the menu first.',
    'sehir.gecisAlt': 'This building is in {sehir}. The site is now shown for {sehir}. You can change it anytime from the menu.',
    ...
    'y.krit1': 'Heating', 'y.krit2': 'Earthquake', 'y.krit3': 'Neighbours', 'y.krit4': 'Management', 'y.krit5': 'Security', 'y.krit6': 'Dues',
    'y.kritEkle': '+ add your own criterion',
    'y.arti': 'PLUS', 'y.sorun': 'ISSUE',
    'y.nelerNot': 'Across 39 districts of Istanbul · Free · Anonymous if you wish',
    'y.nelerNot@kahramanmaras': 'Across 11 districts of Kahramanmaraş · Free · Anonymous if you wish',
    'y.kaydir': 'SCROLL DOWN, THE JOURNEY BEGINS', 'y.hizli': 'QUICK LOOK:',
    'y.a1rozet': 'WHILE BROWSING THE MAP', 'y.a1b1': '"WAIT, I KNOW', 'y.a1b2': 'THIS PLACE."',
    'y.a1alt': 'You lived in Kadıköy, studied in Beşiktaş, worked in Şişli. What do the places you know score?',
    'y.muhurler': 'SEALS',
    'y.a2rozet': 'YOU ENTERED A DISTRICT', 'y.a2b1': '"SO WHAT DID', 'y.a2b2': 'PEOPLE SAY?"',
    'y.a2alt': 'Not a listing blurb — the actual words of people who lived there. The good and the bad.',
    'y.a3rozet': 'A BUILDING CAUGHT YOUR EYE', 'y.a3b1': "\"WHAT'S THIS", 'y.a3b2': "BUILDING'S SCORE?\"",
    'y.a3alt': 'You do not have to read every review. They all add up to one report card.',
    'y.agBaslik': 'Not every seal weighs the same. Who is speaking matters:',
    'y.agSakin': 'Resident — still lives there',
    'y.agEski': 'Former resident — lived there once',
    'y.agZiyaret': 'Visitor — only passed through',
    'y.agNot': 'So one angry review cannot ruin a building, and the voice of someone who truly lived there weighs most.',
    'y.a4rozet': 'AND WHAT YOU REALLY WONDER', 'y.a4b1': '"WHAT ABOUT', 'y.a4b2': 'MY BUILDING?"',
    'y.a4alt': 'Type the name of the building you live in, or the one you are thinking of moving to.',
    'y.yoksa': 'If your building is not here yet — add it. You place the first seal, and its memory starts with you.',
    'y.binaEkle': 'ADD A BUILDING',
    'y.a5rozet': 'END OF THE JOURNEY, START OF THE MEMORY', 'y.a5b1': 'SEAL YOUR', 'y.a5b2': 'BUILDING TOO.',
    'y.a5alt': 'If you have lived in a building, that experience can help someone else decide right. It takes two minutes.',
    'y.a5not': 'Free · Fully anonymous if you wish · Your identity is never shared',
    ...
    'nc.s1b': 'Search', 'nc.s1': "Search for the building by name, street or district; or browse the map. Every sealed building in the city you picked shows up.",
    ...
    'nc.kutu1': "And we do this together. Each seal is a small note on its own; combined, they form the city's building memory. The authority here isn't a company — ", 'nc.kutu2': 'the people who lived it.',
    'nc.cta': 'GET STARTED →',
    ...
    'bk.giris': "Get to know the building before you move in. Explore is where you see sealed buildings in the city you picked, on the map and in lists. Cities we are open in: {sehirler}. Type a building's name, street or district; review the scores, experiences and surroundings analysis left by people who actually lived there — all on one screen.",
    ...
    'bk.k1b': '🗺️ From the Map', 'bk.k1': 'See sealed buildings on the city map; zoom into a district or street, tap the building you care about.',
    ...
    'fo.ilceler@kahramanmaras': 'Kahramanmaraş Districts',
    'ilc.h1a@kahramanmaras': 'Know Kahramanmaraş',
    'ilc.g1@kahramanmaras': "Kahramanmaraş is a deep-rooted Anatolian city whose 11 districts stretch from the foot of Mount Ahır to the Ceyhan valley, from the Elbistan plain to the highlands of Andırın. Known for the title \"Kahraman\" (heroic) earned in the War of Independence, for its ice cream and its handcrafts — every neighborhood has its own rhythm, its own neighborliness, its own life.",
    'ilc.g2a@kahramanmaras': "Since the earthquakes of 6 February 2023, the city is being rebuilt: new buildings are rising, neighborhoods are taking new shape. In times like these, knowing what a building is really like from the outside is nearly impossible; two buildings on the same street can offer two entirely different lives. That's why Bulevini records Kahramanmaraş not district by district, but ",
    'ilc.davet2@kahramanmaras': " We are writing Kahramanmaraş's memory together — be the first to stamp a seal.",
