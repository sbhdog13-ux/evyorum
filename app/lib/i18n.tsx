...
const SOZLUK: { [dil: string]: { [k: string]: string } } = {
  tr: {
    ...
    'acilis.girisKayit': 'GİRİŞ YAP / KAYIT OL', 'acilis.hemenBasla': 'HEMEN BAŞLA →', 'acilis.yakinda': "APP STORE'DA İNDİR →",
  ...
  en: {
    ...
    'acilis.girisKayit': 'SIGN IN / SIGN UP', 'acilis.hemenBasla': 'GET STARTED →', 'acilis.yakinda': 'DOWNLOAD ON THE APP STORE →',
